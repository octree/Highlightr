...
private typealias ThemeDict = [String: [AnyHashable: AnyObject]]
...
open class Theme {
    ...
    internal func styles(for styleList: [String]) -> [NSAttributedString.Key: Any] {
    ...
    private func strippedThemeToString(_ theme: ThemeStringDict) -> String {
        var resultString = ""
    ...
    private func strippedThemeToTheme(_ theme: ThemeStringDict) -> ThemeDict {
        var returnTheme = ThemeDict()
